const recettes = [
  ...
  },
  {
      "id": 9,
      "image": "Recette09.jpg",
      "name": "Salade Méditerrannéene fraîche au chèvre",
      "servings": 4,
      "ingredients": [
          {
              "ingredient": "concombre",
  ...
  },
  {
      ...
      "time": 15,
      "description": "Coupez les fraises en morceaux, découpez la chaire de la pastèque en retirant les pépins. Mettre le tout dans le blender. Ajouter une cuillère à soupe de juste de citron ainsi que les glaçons. Ajoutez quelques feuilles de menthe pour plus de fraîcheur. Mixez le tout. Servir et déguster.",
      "appliance": "Blender",
  ...
  },
  {
      ...
      "time": 60,
      "description": "Étaler la pâte dans un moule et la piquer. Parsemer de beurre. Faire chauffer les lardons dans une poêle. Battre les oeufs en ajoutant la crème fraîche et le lait. Finalement ajouter les lardons, salez poivrez à votre gout. Verser l'ensemble sur la pâte. Cuire environ 50 minutes.",
      "appliance": "Four",
  ...
  },
  {
      ...
      "time": 80,
      "description": "Émincer les blanc de poireaux et les faire chauffer dans 25 grammes de beurre. Ajouter les pommes de terre coupées en morceaux. Ajouter l'eau et laisser mijoter pour 45 minutes. Chauffer l'oseille avec le beurre restant puis incorporer le tout. Mixez. Ajoutez la crème. Bon appétit.",
      "appliance": "Mixer",
  ...
  },
  {
      ...
      "time": 35,
      "description": "Râper les courgette et les faire revenir durant 15 minutes. Ajouter les fromages de chèvre frais. Préparer la béchamel avec le lait et la maïzena. Salez poivrez, ajouter de la noix de muscade selon les gouts. Dans un plat, mettre un peu de sauces au fond, puis des lasagnes, puis des courgettes etc..., terminer par de la sauce et ajouter le gruyère. Passer au four à 180° durant 20 à 25 minutes.",
      "appliance": "Four",
  ...
  },
  {
      ...
      "time": 50,
      "description": "Préchauffez le fours à 200°. Étaler la pâte. La mettre dans un moule. Battre les oeufs avec le sucre. Ajouter le jus de citron et le beurre. Verser le tout sur la pâte. Au four 30 minutes. Bon appétit ",
      "appliance": "Four",
  ...
  },
  {
      ...
      "time": 40,
      "description": "Étaler la pâte a pizza. Écraser les tomates pelées, les étaler sur la pâte, ajouter les lardons et les champignons. Ajouter le gruyère et passer au four à 220° durant 20 minutes",
      "appliance": "Four",
  ...
  },
  {
      ...
      "time": 60,
      "description": "Préparer la frangipane : Mélanger le sucre la poudre d'amandes, le beurre et les oeufs. Étaler la moitié de la pâte feuilletée et mettre dans un moule à tarte. Garnir de frangipane et recouvrir du reste de pâte feuilletée. Mettre au four 30 minutes",
      "appliance": "Four",
